...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="frame">
        ...
        <br />
         <asp:Label ID="Label2" runat="server" Text="NGHIÊN CỨU VÀ PHÁT TRIỂN GIẢI PHÁP OPC UA"></asp:Label>
        <br />
        <asp:Label ID="Label3" runat="server" Text="RESEARCH AND DEVELOPMENT "></asp:Label>
     <br />
        </div>
</asp:Content>